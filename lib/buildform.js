...
Object.keys(definitions).map(function (form) {
	...
	Object.keys(properties).map(function (item, i) {
		...
		formItems.push(React.createElement(Input, { schema: schema, properties: properties, key: i, type: getType(formField.type, formField.format), label: localization(item), field: item }));
	});
});
