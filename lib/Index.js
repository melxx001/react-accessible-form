...
var Form = React.createClass({ displayName: 'Form',
  ...
  render: function render() {
    return React.createElement('div', null, React.createElement(Input, { required: true, minLength: 3, maxLength: 10, validation: 'blur', onChange: this._onChange, preLabel: 'Expense Type1', id: 'id-1' }), React.createElement(Input, { minLength: 10, onChange: this._onChange, preLabel: 'Expense Type2', id: 'id-2' }), React.createElement(Input, { minLength: 10, validation: 'change', postLabel: 'Expense Type3', id: 'id-3' }), React.createElement(Input, { isNumber: true, minLength: 10, validation: 'none', label: 'Expense Type4', id: 'id-4' }), React.createElement(Input, { isNumber: true, minLength: 10, postLabel: 'Expense Type5' }));
  }
});
