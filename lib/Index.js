...
var Component = React.createClass({ displayName: 'Component',
  ...
  render: function render() {
    ...
    React.createElement(Input, {
      ...
      customValidation: this._validate }), React.createElement(TextArea, {
      id: 'id-22',
      name: 'type19',
      label: 'TextArea',
      maxLength: 10,
      ...
      rows: 5,
      cols: 20,
      placeHolder: 'Field Required. Max 10 characters' }), React.createElement(Button, { id: 'id-18', value: 'Button1', disabled: true }), React.createElement(Button, { id: 'id-19', value: 'submit', type: 'submit' }), React.createElement(Button, { id: 'id-20', value: 'reset', type: 'reset' }));
  }
});
