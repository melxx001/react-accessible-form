...
var Select = React.createClass({ displayName: 'Select',
	...
	render: function render() {
		...
		Object.keys(options).forEach(function (option, i) {
			...
			optionsHtml.push(React.createElement('option', { key: choice[0], value: choice[0] }, choice[1]));
		});
		...
		}, optionsHtml), React.createElement('p', { className: this.props.errorClassName }, this.state.validationError));
	}
});
