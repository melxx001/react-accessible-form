    ...
    _onChange: function _onChange(event) {
        ...
        this.setState({
            ...
            if (_this.props.validationEvent && _this.props.validationEvent.toLowerCase() === 'change') {
                _this._validate(_this.state.value, event.target.dataset);
            }
        });
    },
    ...
    render: function render() {
        ...
        if (this.state.errors.length > 0) {
            ...
            this.state.errors.forEach(function (error, i) {
                ...
                errors.push(React.createElement('span', { key: 'errmessage' + i, className: _this2.props.errorClassName }, error));
            });
        }
